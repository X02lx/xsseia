...
OWNER_USERNAME = getenv("OWNER_USERNAME", "JJJ_JJJ")
ALIVE_NAME = getenv("ALIVE_NAME", "seno")
BOT_USERNAME = getenv("BOT_USERNAME", "N1NNNN")
OWNER_ID = getenv("OWNER_ID", "1336874473")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "H69RG")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "N1NNNN")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "N1NNNN")
